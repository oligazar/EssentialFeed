...
class EssentialFeedCacheIntegrationTests: XCTestCase {
    ...
    func test_save_overridesItemsSavedOnASeparateInstance() {
        ...
        let saveExp1 = expectation(description: "Wait for the first save completion")
        ...
        let saveExp2 = expectation(description: "Wait for the last save completion")
        sutToPerformLastSave.save(latestFeed) { latestSaveError in
            XCTAssertNil(latestSaveError)
            saveExp2.fulfill()
        }

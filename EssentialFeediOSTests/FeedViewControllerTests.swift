...
class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageViewLoadinIndicator_isVisibleWhenLoadingImage() {
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageViewRetryButton_isVisibleOnImageURLLoadError() {
        ...
        loader.completeImageLoadingWithError(at: 1)
        XCTAssertEqual(view0?.isShowingRetryAction, false, "Expected no retry action state change for first view once second image loading completed with exception")

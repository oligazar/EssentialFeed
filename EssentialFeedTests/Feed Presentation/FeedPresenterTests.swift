...
final class FeedPresenter {
    ...
    static var title: String {
        NSLocalizedString("FEED_VIEW_TITLE",
                          tableName: "Feed",
                          bundle: Bundle(for: FeedPresenter.self), comment: "Title for the feed view")
    }
    ...
    private var feedLoadError: String {
        NSLocalizedString("FEED_VIEW_CONNECTION_ERROR",
                          tableName: "Feed",
                          bundle: Bundle(for: FeedPresenter.self), comment: "Error message displayed when we can't load the image feed from the server")
    }
...
class FeedPresenterTests: XCTestCase {
    ...
    func test_didFinishLoadingFeedWithError_displaysLocalizedErrorMessage() {
        let (sut, view) = makeSUT()
